...
object ZcColors {
    ...
    val LightBg        = Color(0xFFF5F5FA)
    val LightSurface   = Color(0xFFFFFFFF)
    val LightCard      = Color(0xFFFFFFFF)
    val LightCardLight = Color(0xFFEEEEF4)
    val LightBorder    = Color(0xFFDDDDE5)
    val LightText      = Color(0xFF1A1A2E)
    val LightText2     = Color(0xFF5C5C72)
    val LightText3     = Color(0xFF9898AA)
    val LightUserBg    = Color(0xFFE8E5FF)
    val LightThinkBg   = Color(0xFFF0EEFF)
}
