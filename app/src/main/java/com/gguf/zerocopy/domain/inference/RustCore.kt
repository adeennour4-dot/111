...
/**
 * RustCore — optional Rust optimization layer for ZeroCopy.
 * Provides intelligent scheduling, memory monitoring, and thermal-aware tuning.
 * Falls back gracefully if native library isn't available.
 */
object RustCore {
